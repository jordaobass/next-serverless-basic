...
const getStaticPaths = async () => {
  return {
    paths: [{
      params: {
        orgAndName: ["rocketseat", "umbriel"]
      }
    }, {
      params: {
        orgAndName: ["rocketseat", "adonis-bull"]
      }
    }, {
      params: {
        orgAndName: ["rocketseat", "gatsby-themes"]
      }
    }, {
      params: {
        orgAndName: ["rocketseat", "docs"]
      }
    }],
    fallback: true
  };
...
const getStaticProps = async ({
  ...
  const [org, name] = params.orgAndName;
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9436);
      ...
      const compMod = __webpack_require__(8449)
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [400,436,947,521,142,163,428,750], function() { return __webpack_require__(5978); })
